        ...
        public static void CreateOrders()
        {
            ...
            using (var myDb = new MyDbContext())
            {
                myDb.AddRange(
                    ...
                    new Order { PaymentOption = 0, DeliveryOption = 0, CustomerId = 4 },
                    ...
                    new Order { PaymentOption = 0, DeliveryOption = 4, CustomerId = 2 },
                    new Order { PaymentOption = 1, DeliveryOption = 0, CustomerId = 3 },
                    new Order { PaymentOption = 2, DeliveryOption = 1, CustomerId = 4 },
                    new Order { PaymentOption = 3, DeliveryOption = 2, CustomerId = 5 },
                    new Order { PaymentOption = 0, DeliveryOption = 3, CustomerId = 6 },
                    new Order { PaymentOption = 1, DeliveryOption = 4, CustomerId = 1 },
                    new Order { PaymentOption = 2, DeliveryOption = 0, CustomerId = 2 },
                    new Order { PaymentOption = 3, DeliveryOption = 1, CustomerId = 3 },
                    new Order { PaymentOption = 0, DeliveryOption = 2, CustomerId = 4 },
                    new Order { PaymentOption = 1, DeliveryOption = 3, CustomerId = 5 },
                    new Order { PaymentOption = 2, DeliveryOption = 4, CustomerId = 6 },
                    new Order { PaymentOption = 3, DeliveryOption = 0, CustomerId = 1 },
                    new Order { PaymentOption = 0, DeliveryOption = 1, CustomerId = 2 },
                    ...
                    new Order { PaymentOption = 0, DeliveryOption = 0, CustomerId = 6 },
